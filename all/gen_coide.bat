...
set v_gen_root=%v_repo_root_self%\CoX\CoX_Peripheral\CoX_Peripheral_LPC17xx\all\project
set v_cox_peripheral=%v_repo_root_self%\CoX\CoX_Peripheral\CoX_Peripheral_LPC17xx
...
echo gen coide project: CoX\CoX_Peripheral\CoX_Peripheral_LPC17xx\all\project
